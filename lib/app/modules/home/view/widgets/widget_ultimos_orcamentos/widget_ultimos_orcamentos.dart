...
class WidgetUltimosOrcamentos extends StatefulWidget {
  WidgetUltimosOrcamentos({Key? key, String? valor}) : super(key: key);

  var valor;

  @override
  State<WidgetUltimosOrcamentos> createState() =>
      _WidgetUltimosOrcamentosState();
}

class _WidgetUltimosOrcamentosState
    extends ModularState<WidgetUltimosOrcamentos, HomeStore> {
  @override
