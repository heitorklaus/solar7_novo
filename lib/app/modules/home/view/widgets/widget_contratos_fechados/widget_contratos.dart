...
class WidgetContratosFechados extends StatefulWidget {
  WidgetContratosFechados({Key? key, String? valor}) : super(key: key);

  var valor;

  @override
  State<WidgetContratosFechados> createState() =>
      _WidgetContratosFechadosState();
}

class _WidgetContratosFechadosState
    extends ModularState<WidgetContratosFechados, HomeStore> {
  @override
