...
class CategoriaDosItens extends StatefulWidget {
  const CategoriaDosItens({Key? key}) : super(key: key);

  @override
  _CategoriaDosItensState createState() => _CategoriaDosItensState();
}
        ...
        body: ResponsiveLayout(
          ...
          phone: Padding(
              ...
              child: currentIndex == 0
                  ? WidgetListaDeCategoriaDeItens()
                  : WidgetCategoriaCadastraPage()),
          tablet: Row(
            children: [
