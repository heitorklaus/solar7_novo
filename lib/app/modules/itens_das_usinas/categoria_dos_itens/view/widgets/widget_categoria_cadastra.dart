...
class WidgetCategoriaCadastraPage extends StatefulWidget {
  WidgetCategoriaCadastraPage({Key? key, String? valor}) : super(key: key);

  @override
  State<WidgetCategoriaCadastraPage> createState() =>
      _WidgetCategoriaCadastraPageState();
}

class _WidgetCategoriaCadastraPageState
    extends State<WidgetCategoriaCadastraPage> {
  // A>A>A
  //
