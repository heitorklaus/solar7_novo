...
class WidgetListaFabricante extends StatefulWidget {
  WidgetListaFabricante({Key? key, String? valor}) : super(key: key);

  var valor;

  @override
  State<WidgetListaFabricante> createState() => _WidgetListaFabricante();
}

class _WidgetListaFabricante extends State<WidgetListaFabricante> {
  @override
