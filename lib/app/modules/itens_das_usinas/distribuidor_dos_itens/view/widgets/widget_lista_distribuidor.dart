...
class WidgetListaDistribuidor extends StatefulWidget {
  WidgetListaDistribuidor({Key? key, String? valor}) : super(key: key);

  var valor;

  @override
  State<WidgetListaDistribuidor> createState() => _WidgetListaDistribuidor();
}

class _WidgetListaDistribuidor extends State<WidgetListaDistribuidor> {
  @override
