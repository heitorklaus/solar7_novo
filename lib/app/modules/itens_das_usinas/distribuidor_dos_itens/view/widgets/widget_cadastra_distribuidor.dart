...
class WidgetCadastraDistribuidor extends StatefulWidget {
  WidgetCadastraDistribuidor({Key? key, String? valor}) : super(key: key);

  @override
  State<WidgetCadastraDistribuidor> createState() =>
      _WidgetCadastraDistribuidorState();
}

class _WidgetCadastraDistribuidorState
    extends State<WidgetCadastraDistribuidor> {
  // A>A>A
  //
