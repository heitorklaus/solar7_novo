...
mixin _$Distribuidora on _Distribuidora, Store {
  late final _$idAtom = Atom(name: '_Distribuidora.id', context: context);
  ...
  late final _$itemAtom = Atom(name: '_Distribuidora.item', context: context);
  ...
  late final _$cpf_cnpjAtom =
      Atom(name: '_Distribuidora.cpf_cnpj', context: context);
  ...
  late final _$enderecoAtom =
      Atom(name: '_Distribuidora.endereco', context: context);
  ...
  late final _$telefoneAtom =
      Atom(name: '_Distribuidora.telefone', context: context);
  ...
  late final _$cidadeAtom =
      Atom(name: '_Distribuidora.cidade', context: context);
  ...
  late final _$ufAtom = Atom(name: '_Distribuidora.uf', context: context);
